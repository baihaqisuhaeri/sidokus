<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">📝 Edit Dokumentasi</h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl">
                ...
                <div class="bg-gradient-to-r from-red-600 to-red-800 px-6 py-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-white">Edit Dokumentasi</h1>
                            <p class="text-red-100 text-sm">Update informasi dokumentasi surat suara</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('dokumentasi.update', $dokumentasi->id) }}" 
                    ...
                    <div>
                        ...
                        <select id="jenis_pemilu" 
                            ...
                            <option value="President" {{ old('jenis_pemilu', $dokumentasi->jenis_pemilu) == 'President' ? 'selected' : '' }}>🗳️ Presiden</option>
                            <option value="DPR" {{ old('jenis_pemilu', $dokumentasi->jenis_pemilu) == 'DPR' ? 'selected' : '' }}>🏛️ DPR</option>
                            <option value="DPD" {{ old('jenis_pemilu', $dokumentasi->jenis_pemilu) == 'DPD' ? 'selected' : '' }}>👥 DPD</option>
                            <option value="Provinsi" {{ old('jenis_pemilu', $dokumentasi->jenis_pemilu) == 'Provinsi' ? 'selected' : '' }}>🗺️ Provinsi</option>
                            <option value="Kabupaten/Kota" {{ old('jenis_pemilu', $dokumentasi->jenis_pemilu) == 'Kabupaten/Kota' ? 'selected' : '' }}>📍 Kabupaten/Kota</option>
                        </select>
                        @error('jenis_pemilu')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="jenis_surat_suara" 
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition bg-white">
                            <option value="normal" {{ old('jenis_surat_suara', $dokumentasi->jenis_surat_suara) == 'normal' ? 'selected' : '' }}>👁️ Normal (Untuk Umum)</option>
                            <option value="tunanetra" {{ old('jenis_surat_suara', $dokumentasi->jenis_surat_suara) == 'tunanetra' ? 'selected' : '' }}>👁️ Tunanetra (Braille)</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               id="tahun"
                               name="tahun" 
                               value="{{ old('tahun', $dokumentasi->tahun) }}"
                               min="2000"
                               max="2100"
                        ...
                        @if($dokumentasi->file)
                            <div class="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm font-medium text-gray-800">{{ $dokumentasi->file }}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="border-2 border-dashed border-red-300 rounded-xl p-6 hover:border-red-500 transition bg-red-50">
                            ...
                            <label for="file" class="cursor-pointer">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-600 font-medium">Klik untuk upload file baru</p>
                    ...
                    <div>
                        ...
                        <textarea id="keterangan" 
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition placeholder-gray-400 resize-none">{{ old('keterangan', $dokumentasi->keterangan) }}</textarea>
                        @error('keterangan')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
